          ...
          <Card className="rounded-[16px] border border-slate-200/80 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.02)]">
            ...
            <CardContent className="px-7 pb-7 space-y-5">
              ...
              <div className="h-[42px] flex items-center px-4 rounded-[8px] bg-slate-50 border border-slate-200/60 text-[13px] text-slate-500 font-medium tracking-wide">
                {t('lastSynchronized', { date: '3/11/2026, 10:30:00 AM' })}
              </div>

              <div className="flex items-center gap-3 pt-2">
                <Button
                  variant="outline"
                  className="h-[40px] rounded-[8px] font-semibold text-slate-700 border-slate-200 hover:bg-slate-50 px-5"
                >
                  {t('testConnection')}
                </Button>
                <Button
        ...
        <div className="xl:col-span-4 flex flex-col gap-6 w-full">
          ...
          <Card className="rounded-[16px] border border-slate-200/80 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.02)]">
            ...
            <CardContent className="px-6 pb-6 space-y-3">
              <div className="bg-slate-50/80 rounded-[12px] p-4">
                ...
                <div className="text-[26px] font-black text-slate-800 leading-none">
                  850
                </div>
              </div>
              ...
              <div className="bg-blue-50/50 rounded-[12px] p-4">
                ...
                <div className="text-[26px] font-black text-blue-500 leading-none">
                  1,234
                </div>
              </div>
              ...
              <div className="bg-purple-50/50 rounded-[12px] p-4">
                ...
                <div className="text-[26px] font-black text-[#a855f7] leading-none">
                  127
                </div>
              </div>
            </CardContent>
          ...
          <Card className="rounded-[16px] border border-red-200/60 shadow-sm bg-red-50/30">
            ...
            <CardContent className="px-6 pb-6 space-y-3">
              <Button
                variant="outline"
                className="w-full h-[44px] rounded-[10px] font-bold text-orange-600 border-orange-200 bg-white hover:bg-orange-50/50 hover:text-orange-700"
              >
                {t('suspendSchool')}
              </Button>
              <Button
                variant="outline"
                className="w-full h-[44px] rounded-[10px] font-bold text-red-600 border-red-200 bg-white hover:bg-red-50/50 hover:text-red-700"
              >
                {t('deleteSchool')}
              </Button>
            </CardContent>
