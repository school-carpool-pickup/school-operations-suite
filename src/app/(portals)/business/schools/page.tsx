...
const schools = [
  ...
  },
  {
    ...
    lanes: [
      'Lane A: Grades 1, 2, 3, 4',
      'Lane B: Grades 5, 6, 7, 8',
      'Lane C: Grades 9, 10, 11, 12',
    ],
  },
  {
    id: 3,
            ...
            <CardContent className="p-0">
              ...
              <div className="p-6 py-5">
                <div className="grid grid-cols-2 md:grid-cols-6 gap-6">
                  <div className="flex flex-col">
                    <span className="text-[12.5px] font-semibold text-slate-400 mb-1">
                      {t('students')}
                    </span>
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[18px] font-black text-[#a855f7]">
                      {school.stats.carpools}
                    </span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-[12.5px] font-semibold text-slate-400 mb-1">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span
                      className={`text-[18px] font-black ${school.stats.growth.startsWith('+') ? 'text-emerald-600' : 'text-red-500'}`}
                    >
                      {school.stats.growth}
                    </span>
                  </div>
                ...
                <>
                  ...
                  <div className="p-6 py-5 bg-white">
                    <p className="text-[13px] font-bold text-slate-700 mb-3">
                      {t('pickupLanesConfiguration')}
                    </p>
                    <div className="flex flex-wrap gap-2">
                      {school.lanes.map((lane) => (
                        <div
                          key={lane}
                          className="text-[12.5px] font-semibold px-3 py-1.5 rounded-[8px] border border-slate-200/80 bg-slate-50 text-slate-600 shadow-sm"
                        >
                          {lane}
                        </div>
                      ))}
