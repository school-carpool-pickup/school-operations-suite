...
export default function SchoolSettingsPage() {
  ...
  const [laneToDelete, setLaneToDelete] = useState<LaneConfig | null>(null);

  const handleSave = () => {
    toast.success(t('settingsSavedTitle'), {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-10">
      <div className="flex items-center justify-between">
        ...
        <Button
          onClick={handleSave}
          className="h-10 px-5 rounded-[10px] font-bold gap-2 bg-[#171717] hover:bg-[#262626] text-white shadow-sm transition-colors border-0"
        >
          <Save className="h-[18px] w-[18px]" /> {t('saveSettings')}
        </Button>
      </div>
        ...
        <div className="xl:col-span-2 space-y-6">
          <Card className="shadow-sm border-border/80">
            ...
            <CardContent className="p-6">
              <div className="rounded-[14px] border border-blue-200/60 bg-blue-50/50 p-4.5 px-5">
                <h4 className="font-bold text-[15px] text-blue-900 mb-1">
                  {t('schoolName')}
                </h4>
                <p className="text-[13px] font-medium text-blue-600 hover:underline cursor-pointer transition-colors">
                  {t('schoolDescription')}
                </p>
              </div>
            </CardContent>
              ...
              <div className="rounded-[14px] border border-emerald-200/50 bg-emerald-50/50 p-4.5 flex gap-3 text-[13.5px] font-medium text-emerald-800 leading-relaxed shadow-sm">
                ...
                <div>
                  <span className="font-bold mr-1">
                    {t('aboutGeofencingLabel')}
                  </span>
                  {t('aboutGeofencingBody')}{' '}
                  <span className="font-bold text-emerald-900">
                    {t('aboutGeofencingEmphasis')}
                  </span>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <Label className="text-[13px] font-bold text-foreground">
                    {t('geofenceRadiusLabel')}
                  </Label>
                  <Input
                    type="number"
                    defaultValue={500}
                    className="max-w-md h-12 rounded-[12px] bg-muted/20 border border-border/60 shadow-sm font-medium text-[15px] focus-visible:ring-1 focus-visible:ring-emerald-500/30 transition-all"
                  />
                  <p className="text-[12px] font-medium text-muted-foreground/80 mt-1.5 ml-1">
                    {t('geofenceRadiusHint')}
                  </p>
                </div>
                ...
                <div className="rounded-[16px] border border-emerald-100 bg-[#f8fafc] p-5 flex items-center justify-between mt-6 shadow-[0_1px_2px_rgba(0,0,0,0.02)]">
                  <div className="space-y-1">
                    <div className="font-bold text-[14.5px] text-foreground">
                      {t('currentRadius')}
                    </div>
                    <div className="text-[12.5px] font-medium text-muted-foreground/80">
                      {t('currentRadiusDescription')}
                    </div>
                  </div>
                  <div className="text-3xl font-black text-emerald-500 mr-2 tracking-tight">
                    500m
                  </div>
                </div>
              </div>
          ...
          <Card className="shadow-sm border-border/80">
            <CardHeader className="border-b border-border/40 bg-muted/10 py-5 flex flex-row items-center justify-between">
              ...
              <Badge
                variant="secondary"
                className="font-semibold bg-white text-muted-foreground px-3 py-1 text-[12px] shadow-sm border border-border/60 rounded-full"
              >
                {t('lanesConfiguredCount', { count: 3 })}
              </Badge>
            </CardHeader>
            <CardContent className="p-6 space-y-6 bg-[#fafafa]">
              <div className="rounded-[14px] border border-purple-200/50 bg-purple-50/50 p-4.5 flex gap-3 text-[13.5px] font-medium text-purple-800 leading-relaxed shadow-sm">
                ...
                <div>
                  <span className="font-bold mr-1">
                    {t('laneAssignmentLabel')}
                  </span>
                  {t('laneAssignmentBody')}
                </div>
              </div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={lane.name}
                    className="flex flex-row items-center justify-between rounded-[14px] border border-border/80 p-4 px-5 bg-white shadow-[0_1px_3px_rgba(0,0,0,0.02)] transition-colors"
                  >
                    <div className="space-y-2.5">
                      <div className="flex items-center gap-3.5">
                        ...
                        <Badge
                          variant="secondary"
                          className="bg-muted/50 text-[11px] text-muted-foreground/80 px-2 py-0.5 border border-border/40 font-bold tracking-wide rounded-[8px]"
                        >
                          {t('laneGradesBadge', { grades: lane.grades })}
                        </Badge>
                      </div>
                      <p className="text-[13px] font-medium text-muted-foreground/90 flex items-center gap-2">
                        <MapPin className="text-[#EF4444] h-[15px] w-[15px]" />{' '}
                        {lane.label}
                      </p>
                    </div>
                    <Button
                      ...
                      variant="ghost"
                      size="icon"
                      className="h-[42px] w-[42px] rounded-[12px] bg-red-50 text-red-500 hover:bg-red-100 hover:text-red-700 transition-colors shadow-none shrink-0 border border-red-50"
                    >
              ...
              <div className="rounded-[16px] p-6 bg-white border border-border shadow-sm border-dashed">
                <div className="space-y-5">
                  <div className="space-y-2">
                    <Label className="text-[11.5px] text-muted-foreground/80 uppercase tracking-wider font-bold">
                      {t('laneNameLabel')}
                    </Label>
                    <Input
                      placeholder={t('laneNamePlaceholder')}
                      className="h-[46px] rounded-[12px] bg-muted/10 border border-border/60 shadow-sm text-[14.5px] font-medium focus-visible:ring-1 focus-visible:ring-primary/20 transition-all"
                    />
                  </div>
                  <div className="space-y-2">
                    <Label className="text-[11.5px] text-muted-foreground/80 uppercase tracking-wider font-bold">
                    ...
                    <Input
                      placeholder={t('laneGradesPlaceholder')}
                      className="h-[46px] rounded-[12px] bg-muted/10 border border-border/60 shadow-sm text-[14.5px] font-medium focus-visible:ring-1 focus-visible:ring-primary/20 transition-all"
                    />
                  </div>
                  <div className="space-y-2">
                    <Label className="text-[11.5px] text-muted-foreground/80 uppercase tracking-wider font-bold">
                      {t('physicalLocationLabel')}
                    </Label>
                    <Select defaultValue="main">
                      ...
                      <SelectContent className="rounded-[14px] shadow-xl border-border/60 max-h-[300px]">
                        <SelectItem
                          value="main"
                          className="text-[14px] font-medium py-2.5 px-3"
                        >
                          {t('locationMain')}
                        </SelectItem>
                        <SelectItem
            ...
            <CardContent className="p-6 space-y-6">
              ...
              <div className="space-y-6">
                {[
                  ...
                  {
                    name: 'Back Entrance',
                    id: 'f7826da6-4fa2-4e98-8024-bc5b71e0893f',
                  },
                ].map((beacon) => (
                  <div
                    key={beacon.id}
                    className="space-y-2 p-4 rounded-[14px] border border-border/60 bg-white shadow-sm"
                  >
                    <div className="flex items-center gap-3">
                      <span className="h-[22px] w-[22px] bg-blue-100 text-blue-600 rounded-[6px] flex items-center justify-center shrink-0">
                        ...
                        >
                          <title>{t('beaconSignalTitle')}</title>
                          <path
                            d="M5 0.5V14.5M5 0.5L9.5 5L5 9.5M5 0.5L0.5 5L5 9.5M5 14.5L9.5 10L5 5.5M5 14.5L0.5 10L5 5.5"
                            stroke="currentColor"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                          />
                      ...
                      <h4 className="font-bold text-[14.5px] text-foreground">
                        {beacon.name}
                      </h4>
                    </div>
                    <p className="font-mono text-[12px] font-medium text-muted-foreground/60 truncate pl-8">
                      {beacon.id}
                    </p>

                    <div className="mt-4 pt-3 border-t border-border/40 space-y-1.5 pl-8">
                      <Label className="text-[12px] font-bold text-foreground">
                        {t('triggerDistanceLabel')}
                      </Label>
                      <Input
                        type="number"
                        defaultValue={50}
                        className="h-11 rounded-[10px] bg-muted/20 border-border/60 shadow-none font-medium mt-1"
                      />
                      <p className="text-[11.5px] font-medium text-muted-foreground/70 mt-1">
                        {t('triggerDistanceHint')}
                      </p>
                    </div>
                  </div>
                ))}
            ...
            <CardContent className="p-6 space-y-4">
              <div className="flex items-center justify-between p-4 px-5 rounded-[16px] bg-emerald-50/60 border border-emerald-100 shadow-sm">
                <div className="flex flex-col gap-1">
                  <span className="text-[12.5px] text-emerald-800/80 font-bold uppercase tracking-wider">
                    {t('summaryGeofenceRadius')}
                  </span>
                  <span className="font-black text-[22px] text-emerald-500 tracking-tight leading-none">
                    500m
                  </span>
                </div>
              ...
              <div className="flex items-center justify-between p-4 px-5 rounded-[16px] bg-purple-50/60 border border-purple-100 shadow-sm">
                <div className="flex flex-col gap-1">
                  <span className="text-[12.5px] text-purple-800/80 font-bold uppercase tracking-wider">
                    {t('summaryPickupLanes')}
                  </span>
                  <span className="font-black text-[22px] text-purple-500 tracking-tight leading-none">
                    3
                  </span>
                </div>
              ...
              <div className="flex items-center justify-between p-4 px-5 rounded-[16px] bg-blue-50/60 border border-blue-100 shadow-sm">
                <div className="flex flex-col gap-1">
                  <span className="text-[12.5px] text-blue-800/80 font-bold uppercase tracking-wider">
                    {t('summaryBleBeacons')}
                  </span>
                  <span className="font-black text-[22px] text-blue-500 tracking-tight leading-none">
                    2
                  </span>
                </div>
